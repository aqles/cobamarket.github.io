...
<html lang="en">
<head>
<title>StoreTerate an E-commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Site map :: w3layouts</title>
	...
	<div class="sitemap">
		<div class="container"> 
			...
			<div class="sitemap-row2  sitemap-text"> 
				<h3 class="w3sitemap-title"><i class="fa fa-gears"></i>StoreTerate Services</h3>  
