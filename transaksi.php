				...
				<div class="welcome-info">
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="myTab" class=" nav-tabs" role="tablist">
							...
							<li role="presentation" class="active"><a href="#carl" role="tab" id="carl-tab"
									data-toggle="tab">
									<i class="fa fa-truck" aria-hidden="true"></i>
									<h5>Dikirim</h5>
								</a></li>
							<li role="presentation" class="active"><a href="#james" role="tab" id="james-tab"
									data-toggle="tab">
									<i class="fa fa-gift" aria-hidden="true"></i>
									<h5>Diterima</h5>
								</a></li>
							<li role="presentation" class="active"><a href="#decor" role="tab" id="decor-tab"
									data-toggle="tab">
