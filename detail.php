...
<body>
	...
	<div class="products">	 
		<div class="container">  
			...
			<?php 
			$article=$db->get_one($_GET['id_barang']);
			?>
				<div class="single-page-row" id="detail-21">
					<div class="col-md-6 single-top-left">	
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="admin/<?php echo $article['gambar']; ?>">
									<div class="thumb-image detail_images"> <img src="admin/<?php echo $article['gambar']; ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<li data-thumb="admin/<?php echo $article['gambar']; ?>">
									 <div class="thumb-image"> <img src="admin/<?php echo $article['gambar']; ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<li data-thumb="admin/<?php echo $article['gambar']; ?>">
								   <div class="thumb-image"> <img src="admin/<?php echo $article['gambar']; ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li> 
				...
				?>
					<div class="col-md-6 single-top-right">
						<h3 class="item_name"><?php echo $article['nama_produk'] ?></h3>
						<p>Proses Pengiriman Barang Kurang Lebih 2-3 kerja</p><a href="">Untuk Lebih Jelasnya Disini</a>
						...
						<div class="single-price">
							<ul>
								<li>Rp.<?php echo number_format($article['harga'],0,',','.') ?></li>  
								<li><p style="background: red; padding: 1px; color: #fff; border-radius: 3px;">Stock :<?php echo $article['qty'] ?></p></li> 
								<li><span class="w3off"><?php echo $article['diskon']; ?></span></li> 
								<li><a href="#"><i class="fa fa-truck" aria-hidden="true"></i> Pilihan Jasa Pengiriman</a></li>
							</ul>	
						</div> 
						<p class="single-price-text"><?php echo $article['ket'] ?></</p>
							<form method="post" action="handler.php?aksi=beli">
							<i class="fa fa-truck" aria-hidden="true"></i> Pilihan Jasa Pengiriman Gratis<br>
							<select name="jasa_pengiriman" style="padding: 10px; width: 200px; ">
									<option>--Pilih Jasa Pengiriman--</option>
									<option value="JNE REGULER">JNE REGULER</option>
									<option value="JNE KILAT">JNE KILAT</option>
							...
							<input type="hidden" name="id_barang" value="<?php echo $article['id'] ?>" />
							<input type="hidden" name="nama_produk" value="<?php echo $article['nama_produk'] ?>" />
							...
							<button class="w3ls-cart w3ls-cart-like"><i class="fa fa-heart-o" aria-hidden="true"></i> Add To Carth</button>
							</form>
