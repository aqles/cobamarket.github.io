...
<div class="header">
	<div class="header-two"><!-- header-two -->
		<div class="container">
			<div class="header-logo">
				<h1><a href="index.php"><span>S</span>tore<i>Terate</i></a></h1>
				<h6>www.teratestore.com</h6>
			</div>
			<div class="header-search">
				<form action="#" method="post">
					<input type="search" name="Search" placeholder="Aku Mau Belanja..." required="">
			...
			<div class="header-cart">
				...
				<div class="cart">
					...
					<a href="checkout.php"><button class="w3view-cart" type="submit" name="submit" value=""><i
	...
	<div class="w3ls-header" style="margin-top: -140px;"><!--header-one-->
		<div class="w3ls-header-left">
			<p><a href="#">Situs Belnaja Mudah & Terpercaya</a></p>
		</div>
		<div class="w3ls-header-right">
			...
			if ($_SESSION['pembeli']) {
				?>
				<?php
				$ker = $db->get_cart_count($_SESSION['id_pembeli']);
				?>
				<ul>
					<li class="dropdown head-dpdn">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"
								aria-hidden="true"></i><?php echo $_SESSION['pembeli'] ?><span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="transaksi.php">Transaksi</a></li>
							<li><a href="handler.php?aksi=logout">Logout</a></li>

						</ul>
					</li>
					<li class="dropdown head-dpdn">
						<a href="#" class="dropdown-toggle"><i class="fa fa-map-marker" aria-hidden="true"></i> Keranjang
							Saya (<?php echo $ker ?>)</a>
					</li>
					<li class="dropdown head-dpdn">
						<a href="card.php" class="dropdown-toggle"><i class="fa fa-credit-card-alt" aria-hidden="true"></i>
							Cara Pembayaran</a>
					</li>
					<li class="dropdown head-dpdn">
						<a href="help.php" class="dropdown-toggle"><i class="fa fa-question-circle"
								aria-hidden="true"></i>Batuan</a>
					</li>
				</ul>
				<?php
			} else {
				...
				<ul>
					...
					<li class="dropdown head-dpdn">
						<a href="contact.php" class="dropdown-toggle"><i class="fa fa-map-marker" aria-hidden="true"></i>
							Store Finder</a>
					</li>
					<li class="dropdown head-dpdn">
						<a href="card.php" class="dropdown-toggle"><i class="fa fa-credit-card-alt" aria-hidden="true"></i>
		...
		<div class="container">
			<div class="menu">
				<div class="cd-dropdown-wrapper">
					<a class="cd-dropdown-trigger" href="#0" style="font-family: arial; font-size: 16px">Kategori</a>
			...
			<div class="move-text">
				<div class="marquee"><a href="offers.php"> Situs belanja online yang mudah aman & terbukti
						terpercaya<span>Dapatkan berbagai promo menarik untuk kebutuhan belanja anda </span> <span> Dan
							jangan kawatir uang pasti kembali 100%</span></a></div>
