...
<html lang="en">
<head>
<title>StoreTerate an E-commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Products3 :: w3layouts</title>
	...
	<div class="products">	 
		<div class="container">
			<div class="col-md-9 product-w3ls-right">
				...
				<?php 
					$db->tampil_produk_elektronik_list();
				 ?>
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<?php
							...
							<a href="single.php"><img src="admin/<?php echo $r['gambar'] ?>" style="height: 200px;" class="img-responsive" alt="img"></a>
									<h4><a href="products.php"><?php echo $r['nama_produk']; ?></a></h4> 
