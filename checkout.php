...
.container1{max-width:1020px;margin:0 auto;margin-top:50px;}
.post{width:130%;float:left}
.article{}
...
?>
<tr><td>Total Bayar :</td><td colspan="3"></td><td colspan="3"><?php echo "Rp. ".number_format($db->total_bayar($_SESSION['id_pembeli']),0,',','.')." Rupiah" ?></td></tr>
</table><br />
