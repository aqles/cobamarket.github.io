...
class data {
    ...
    function login($username, $password) {
        ...
        $query = $this->conn->query("select * from pembeli where username='$username' and password='$password'");
        ...
        while ($r = $query->fetch_array()) {
            ...
            <div class="col-md-3 product-grids">
                <div class="agile-products">
                    ...
                    <a href="single.php"><img src="admin/<?php echo $r['gambar'] ?>" class="img-responsive" alt="img" style="width: 200px; height: 150px;"></a>
