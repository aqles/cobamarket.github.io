            ...
            <div class="carousel-inner" role="listbox">  
                <div class="item active"><!-- First-Slide -->
                    ...
                    <div class="carousel-caption kb_caption kb_caption_right">
                        <h3 data-animation="animated flipInX">Produk Pakaian <span>Diskon </span> 20%</h3>
                        <h4 data-animation="animated flipInX">Hot Hanya Hari ini</h4>
                    </div>
                </div>  
		...
		<div class="container"> 
			<div class="welcome-info">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					...
					<h3 class="w3ls-title" style="font-family: arial; color: #444; font-size: 18px">Produk Ungggulan Pilihan Anda</h3>
		...
		<div class="container">  
			<div class="add-products-row">
				<div class="w3ls-add-grids">
					<a href="fashion.php"> 
						<h4>BELANJA SEPUASNYA DAN DAPAT PENAWARAN LUAR BIASA<span>20%</span> OFF</h4>
						<h6>Aku mau <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
					</a>
				</div>
				<div class="w3ls-add-grids w3ls-add-grids-mdl">
					<a href="fashion.php"> 
						<h4>SPESIAL HARI INI DISKON PRODUK FASHION <span>10%</span> OFF</h4>
						<h6>Belanja Sekarang <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
					</a>
				</div>
				<div class="w3ls-add-grids w3ls-add-grids-mdl1">
					<a href="elektronik.php"> 
						<h4>MAU CARI GADGET KEREN DAN MURAH <span> Bingung  !</span></h4>
						<h6>Cari Disini<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
					</a>
				</div>
